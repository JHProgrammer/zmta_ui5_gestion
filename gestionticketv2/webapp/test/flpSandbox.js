		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Gestion Ticket V2",
									"targetURL": "#capgestionticketv2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"capgestionticketv2-display": {
								"semanticObject": "capgestionticketv2",
								"action": "display",
								"description": "App para gestionar tickets",
								"title": "Gestion Ticket V2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cap.gestionticketv2",
									"url": sap.ui.require.toUrl("cap/gestionticketv2")
								}
							}
						}
					}
